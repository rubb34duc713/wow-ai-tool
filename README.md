...
`secrets` table. It also creates sensible indexes and row‑level security
policies. After running the script you can add the Supabase keys to `.env` and
Vercel as described in the build plan.
