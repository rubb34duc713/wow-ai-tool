...
create policy "basic-auth" on public.transcriptions
...
create policy "basic-auth" on public.analysis_details
  for all using (auth.role() in ('authenticated','service_role'));
...
create policy "basic-auth" on public.summary_clusters
  for all using (auth.role() in ('authenticated','service_role'));
...
create policy "basic-auth" on public.conversations
  for all using (auth.role() in ('authenticated','service_role'));
...
create policy "basic-auth" on public.messages
  for all using (auth.role() in ('authenticated','service_role'));
